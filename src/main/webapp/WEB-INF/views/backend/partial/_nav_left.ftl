		...
		<ul class="nav" id="side-menu">
			...
			<li <#if menuId==1 >class="active"</#if>>
				...
				<ul class="nav nav-second-level">
					<li><a href="${backendUrl}/category/" <#if subMenuId==101 >class="active"</#if>>博客分类</a></li>
					<li><a href="${backendUrl}/post/" <#if subMenuId==102 >class="active"</#if>>博客文章</a></li>
					<li><a href="${backendUrl}/comment/" <#if subMenuId==103 >class="active"</#if>>文章评论</a></li>
					<li><a href="${backendUrl}/viewlog/" <#if subMenuId==104 >class="active"</#if>>阅读记录</a></li>
				</ul>
			</li>
