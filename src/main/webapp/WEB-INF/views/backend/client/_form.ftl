...
<div class="form-group">
	...
	<div class="col-sm-3"><@spring.formInput "client.createdAt",'class="form-control form-input-sep"' /></div>
	<@spring.showErrors " "/>
</div>
<div class="form-group">
	<label class="col-lg-2 control-label">更新时间</label>
	<div class="col-sm-3"><@spring.formInput "client.updatedAt", 'class="form-control form-input-sep"' /></div>
	<@spring.showErrors " "/>
</div>